...
router.get("/", async (req, res) => {
  ...
  try {
    ...
    if (!findAllProducts) {
      res.status(404).json({ message: "No products were found. Please try again." });
      return;
    }
...
router.get("/:id", async (req, res) => {
  ...
  try {
    ...
    if (!productById) {
      res.status(404).json({ message: "No products were found using this id found. Please try again." });
      return;
    }
